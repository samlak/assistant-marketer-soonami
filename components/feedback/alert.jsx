...
export function Feedback({
  ...
  return (
    <AlertDialog open={isFeedbackActive}>
      <AlertDialogContent className="max-w-[600px] sm:w-[90%]">
        <h3 className="font-semibold text-center"> 
          We apologise for the interruption. Although it might be too early, 
          we are eager to hear your feedback on enhancing our platform to serve your needs better.
        </h3>
        <Form {...form}>
